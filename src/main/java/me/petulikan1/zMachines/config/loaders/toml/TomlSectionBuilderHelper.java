package me.petulikan1.zMachines.config.loaders.toml;
...
import me.petulikan1.zMachines.config.loaders.yaml.YamlSectionBuilderHelper;
...
public class TomlSectionBuilderHelper {
    ...
    private static void processEntries(Map<String, Section> keysWithoutSub, Map<String, Section> map, Set<Map.Entry<String, DataValue>> set) {
        if (set.size() >= 512) {
    ...
    public static Iterator<CharSequence> prepareBuilder(Set<String> primaryKeys, DataLoader dataLoader, boolean markSaved) {
        ...
        YamlSectionBuilderHelper.StringArrayList values = new YamlSectionBuilderHelper.StringArrayList();
